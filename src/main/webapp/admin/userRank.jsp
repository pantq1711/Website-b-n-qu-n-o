					...
					<div class='card'>
						<div class="info-dashs">
							<div class='info-dash card-header'
								...
								<p>
								<p style="font-size: 18px;">KHÁCH HÀNG V.I.P</p>
							</div>
							<div class='info-dash card-header'
						...
						<div class='card-body'>
							<table class="table table-striped">
								...
								<tbody>
									...
									HashMap<String,String> list = dao.getTop5User();
									int count = 1;
									for (String i : list.keySet()) {
										
									%>
									<tr>
										<td class="order" style="width: 30%; text-align: center;">
											<%=count%>
										</td>
										<td class="info-product"
											style="color: black; width: 80%; background-color: #f9fcff; background-image: linear-gradient(147deg, #f9fcff 0%, #dee4ea 74%); margin-bottom: 20px; border-radius: 10px; box-shadow: rgba(0, 0, 0, 0.12) 0px 1px 3px, rgba(0, 0, 0, 0.24) 0px 1px 2px;">
											<div class="name-img">
											...
											<div>
												...
												<p style="color: #ff0000; font-weight: 600;">
													Số tiền chi tiêu:
													<%=list.get(i) %><span style="text-decoration: underline;">đ</span>
												</p>
											</div>
									</tr>
									<%
